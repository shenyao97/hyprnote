...
Char is free forever for local transcription, BYOK, and all core features. The managed cloud service ($8/month) adds the easiest setup without managing API keys. Enterprise is relevant when your organization needs on-premises deployment, SSO integration, or custom branding for compliance requirements.
